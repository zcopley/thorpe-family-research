...
1. Confirm relationship between maiden name Caswell and listed Bangle household entries.
2. Reconcile `Angeline` and `Cazwell` naming forms in late entries.
3. Validate all cited rows from image-level census pages.
...
```text
CASWELL, Angeline (7 Oct 1821 - 8 Nov 1908)
...
1880 Wisconsin, Eau Claire County, Otter Creek Township, Page 528 B
D/F
14/14
...
1900 Wisconsin, Eau Claire County, Augusta, Spring Street, Sheet 3B
Add Name
51/52 Cazwell BANGLE
Amelia W BANGLE
Emil R ROEPKE
Series: T623, Roll: 1787, Page: 3B
...
1. `References/raw/inbox/2026-04-24-census-indesign/CensusSummary-CaswellAngeline.txt`
