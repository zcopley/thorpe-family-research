...
- **Name:** Elizabeth Bangle
- **Role in this project:** Individual indexed in Census InDesign summary (2026-04-24 intake).

## Source-Cited Facts

- A census-summary entry provides household and occupational data for multiple census years (1841-1871 UK censuses).
- The detailed census extract is available in: `References/raw/inbox/2026-04-24-census-indesign/CensusSummary-BangleElizabeth.txt`
...
2. `References/raw/inbox/2026-04-24-census-indesign/CensusSummary-BangleElizabeth.txt`
