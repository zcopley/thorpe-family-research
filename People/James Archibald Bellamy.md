...
- A census-summary entry gives James Archibald Bellamy as born 6 Dec 1888 and died 3 May 1982.
...
1. Reconcile `Archibald`, `James A`, and `James Archibold` naming variants as one identity.
2. Validate incomplete RG14 reference fields from source images.
3. Confirm migration path from Peterborough to Chelmsford.
...
```text
BELLAMY, James Archibald (6 Dec 1888 - 3 May 1982)
...
1911 Essex, Chelmsford, 5 Bradford Street
Name
Relationship Marr
Years Sex
Age
...
(RG14PN10054 RG78PN529 RD194 SD2 ED9 SN248)
