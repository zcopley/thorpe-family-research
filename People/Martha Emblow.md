...
- The processed Bellamy timeline review also keeps Martha Emblow in the Joseph Emblow branch and shows her as the key bridge into the Emma Kelly generation.

## Research Gaps

1. Confirm Emblow-to-Kelly marital linkage from primary marriage records.
2. Validate incomplete RG10 fields in the 1871 segment from image-level records.
