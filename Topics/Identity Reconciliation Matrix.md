---
title: Identity Reconciliation Matrix
date: 2026-04-23
tags:
  - "#thorpe-family"
  - "#topic"
...
graph TD
  ...
  C[Low confidence<br/>branch-level only]

  A --> Ann[Ann Sorrell]
  A --> Eleanor[Eleanor Emblow]
  A --> Sarah[Sarah Kelly]
  A --> Susan[Susan Lewis]
  A --> MaryG[Mary Greenwood vs Mary Bergett]

  B --> Wynat[Wynat Lewis]
  C --> Uriah[Uriah Blake Thorpe vs<br/>Uriah Blake Lemmon]
```
...
| [[People/Sarah Kelly|Sarah Kelly]] | **RESOLVED** | 20-year census sequence (1841-1861) as household member, widow, and almshouse resident; consistent birthplace (Cambridgeshire, Whittlesey); clear family relationship to son James Kelly. | ✓ Identity confirmed via source text. `Barton?` was filename reference, not surname clue. Image verification pending (GSU/RG9 pieces available). |
